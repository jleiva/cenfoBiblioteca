...
public class UI {
    ...
    private static int leerOpcionSelecionada()throws java.io.IOException{
        ...
        try {
            ...
            out.print("[Error] Opcion invalida.");
        }
        out.println();
                        ...
                        switch (tipoUsuario) {
                            case 1:
                                ...
                                try {
                                    ...
                                    try {
                                        gestor.crearEstudiante(nombre, apellido, idNuevoUser, carrera, creditos, password);
                            ...
                            case 2:
                                ...
                                try {
                                    ...
                                    try {
                                        gestor.crearProfesor(nombre, apellido, idNuevoUser, contrato,
                                                fechaContratacion, password);
                                        out.println("Se creo el nuevo Usuario.");
                                    } catch (Exception e) {
                                        out.println(e.getMessage());
                                    }
        ...
        do {
            ...
            switch (opc) {
                case 1:
                    ...
                    try {
                        out.println(gestor.listarMaterialesExistentes());
                    } catch (Exception e) {
                        out.println(e.getMessage());
                    }
        ...
        do {
            ...
            switch (opc) {
                ...
                case 2:
                    ...
                    try {
                        out.println(gestor.listarMateriales()); // Muestra solo los materiales Disponibles
                    } catch (Exception e) {
                        out.println(e.getMessage());
                    }
                    ...
                    try {
                        gestor.crearReservacion(idUser, idMaterial);
