/*
 * Created by JFormDesigner on Sun Dec 18 18:40:46 CST 2016
 */
...
public class menuTemasUI extends JFrame {
    ...
    private void initComponents() {
        ...
        //---- label1 ----
        label1.setText("Submenu Temas");
        label1.setFont(new Font("Segoe UI", Font.BOLD, 20));

        //---- VerMaterialBtn ----
        VerMaterialBtn.setText("1. Ver lista de Temas");
        VerMaterialBtn.addActionListener(e -> UsuariosActionPerformed(e));

        //---- EliminarMaterialBtn ----
        EliminarMaterialBtn.setText("4. Eliminar Tema");
        EliminarMaterialBtn.addActionListener(e -> EliminarUsuarioBtnActionPerformed(e));

        //---- BuscarMaterialBtn ----
        BuscarMaterialBtn.setText("3. Buscar Tema");

        //---- RegistrarMaterialBtn ----
        RegistrarMaterialBtn.setText("2. Registrar nuevo Tema");
        ...
        ModificarMaterialBtn.setText("5. Modificar Tema");
